module Admin::BaseHelper
  ...
  def remove_link_unless_new_record(fields)
    out = ''
    out << link_to("<span class=\"ui-icon ui-icon-circle-close\"></span>", "##{fields.object.class.name.underscore}", :class => 'remove ui-state-default ui-corner-all')
    out << link_to("<span class=\"ui-icon ui-icon-circle-close\"></span>", "##{fields.object.class.name.underscore}", :class => 'mark_for_destroy ui-state-default ui-corner-all') unless fields.object.new_record?
    out << fields.hidden_field(:_delete, :class => 'destroy_field') unless fields.object.new_record?
    out
  end
